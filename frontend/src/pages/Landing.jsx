...
//       <header className="relative z-10 max-w-6xl mx-auto w-full flex items-center justify-between px-6 py-3 sm:py-5">
...
//         <section className="relative z-10 max-w-4xl mx-auto text-center px-6 pt-3 sm:pt-8 pb-5 sm:pb-10">
...
//         <section className="relative z-10 max-w-5xl mx-auto w-full px-6 pb-6 sm:pb-14">
